...
describe('Seller', () => {
  ...
  describe('GET /seller/sellcount/:num/:seq', function () {
    ...
    describe('when num is a negative integer', () => {
      it('should be treated as its absolute value', () => {
        return request(server)
    ...
    describe('when num is a negative float number', () => {
      it('should be treated as the smallest integer larger than the num and then do the absolute operation', () => {
        return request(server)
            .get('/seller/sellcount/-2.5/-1')
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
        ...
        it('should return a list ascending by rankRate', () => {
          return request(server)
              ...
              .then((res) => {
                ...
                let seller2 = _.nth(res.body.data, 1)
                let seller3 = _.nth(res.body.data, 2)
                expect(seller1.name).equals('Test3')
      ...
      it('should return all sellers', () => {
        return request(server)
            ...
            .then((res) => {
              ...
              expect(seller3.name).equals('Test2')
              expect(seller3.rankRate).to.equal(95)
              expect(seller4.name).equals('Test1')
              expect(seller4.rankRate).to.equal(80)
              expect(seller5.name).equals('Test3')
              expect(seller5.rankRate).to.equal(79.9)
            })
            .catch((err) => {
              console.log(err)
            })
